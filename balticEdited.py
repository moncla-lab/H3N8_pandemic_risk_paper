# edited baltic.py from https://github.com/evogytis/baltic/blob/master/baltic/baltic.py
# jordan ort edited this so you can use edge colors in plotPoints()
...
class tree: ## tree class
	...
	# edge color added by jordan ort
